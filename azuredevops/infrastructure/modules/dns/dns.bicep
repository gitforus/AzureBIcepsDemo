// reference this please https://github.com/Azure/ResourceModules/tree/main/modules/Microsoft.Network/privateDnsZones

// Below code is just for the reference again. Needs a lot of fixing, we need to keep only relevant part.
